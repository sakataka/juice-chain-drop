...
`Auto Play` を押すと、その場でゲームが始まり、AIが果物ペアとJuice Dropの着地点を選びながら自動でプレイします。AIは選択中のモードに合わせて目標を切り替え、`Chain Challenge` では盤面が安全な間は連鎖を仕込み、終盤や危険時には発火・盤面回復へ移ります。もう一度押すと停止し、キーボードやタッチで操作しても即座に手動操作へ戻ります。設定の `Auto Play Pace` から `Calm`, `Flow`, `Rush` を選べます。
